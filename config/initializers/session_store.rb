...
unless Rails.env.development?
  ...
  Rails.application.config.session_store :cookie_store, key: 'community_id' , same_site: :none , secure: true, domain: Rails.env.production? ? :all :  "pynwheel-staging.herokuapp.com" 
