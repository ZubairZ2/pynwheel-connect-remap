...
#Info Bubble Text
VIRTUAL_TOUR_BUBBLE_TEXT = "Add a URL specific to this Unit/Floorplan which will appear on the interactive map and in the Unit/Floorplan gallery. URLs added at the unit level supersede URLs added here at the floor plan level: URL entered here will not appear on the unit pop-up if enough URLs are added at the unit level. Pynwheel Map can accommodate up to 3 buttons. Pynwheel Touch can accommodate up to 1 button. Pynwheel Touch Mobile can accommodate up to 1 button. Pynwheel Tour can accommodate up to 1 button."
ADDITIONAL_BUTTON_BUBBLE_TEXT = "Add an Additional URL specific to this Unit/Floorplan which will appear on the interactive map and in the Unit/Floorplan gallery. URLs added at the unit level supersede URLs added here at the floor plan level: URL entered here will not appear on the unit pop-up if enough URLs are added at the unit level. Pynwheel Map can accommodate up to 3 buttons. Pynwheel Touch can accommodate up to 1 button. Pynwheel Touch Mobile can accommodate up to 1 button. Pynwheel Tour can accommodate up to 1 button."
SCHEDULED_TOUR_BUBBLE_TEXT = "Add an Additional URL specific to this Unit/Floorplan which will appear on the interactive map and in the Unit/Floorplan gallery. URLs added at the unit level supersede URLs added here at the floor plan level: URL entered here will not appear on the unit pop-up if enough URLs are added at the unit level. Pynwheel Map can accommodate up to 3 buttons. Pynwheel Touch can accommodate up to 1 button. Pynwheel Touch Mobile can accommodate up to 1 button. Pynwheel Tour can accommodate up to 1 button."
