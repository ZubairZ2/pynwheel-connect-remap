module CommunitiesHelper
  ...
  def fetch_unit_data_attributes(unit, struct)
    { 
      ...
      "available-date": struct[:available_date] ? determine_available_date(struct[:available_date]) : nil,
      "market-rent": struct[:market_rent] ? number_with_precision(struct[:market_rent], precision: 2, delimiter: ',') : nil,
      "total-market-rent": struct[:market_rent] ? number_with_precision(struct[:market_rent], precision: 2, delimiter: ',') : nil,
