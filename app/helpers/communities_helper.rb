module CommunitiesHelper
    ...
    tour_histories = TourHistory.where(tour_id: community.tour.id, verfied_by: "authenteq")
    tour_histories.all.each do |th|
      if th.present?
        ...
        worksheet.write(row, 5, tour_user.created_at,format1)
        worksheet.write(row, 6, tour_user.created_at,format1)
