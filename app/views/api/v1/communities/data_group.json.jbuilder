...
json.homepage_design do
  ...
  json.display_button_image @community_group.group_design.present? ? (@community_group.group_design.display_button_image.present? ? @community_group.group_design.display_button_image : true) : true rescue true
  begin
