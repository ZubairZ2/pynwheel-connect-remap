...
json.homepage_design do
  ...
  json.logo_size @community_group.group_design.logo_size.present? ? @community_group.group_design.logo_size : "487x160" rescue "487x160"
  ...
  json.button_border_color @community_group.group_design.button_border_color.present? ? @community_group.group_design.button_border_color : "#3B3B3B"  rescue "#3B3B3B"
  json.button_border_opacity @community_group.group_design.button_border_opacity.present? ? @community_group.group_design.button_border_opacity : "100%"  rescue "100%"
  json.button_border_thickness @community_group.group_design.button_border_thickness.present? ? @community_group.group_design.button_border_thickness : "0px"  rescue "0px"
  json.button_font_family @community_group.group_design.button_font_family.present? ? @community_group.group_design.button_font_family : ""  rescue ""
  json.button_font_size @community_group.group_design.button_font_size.present? ? @community_group.group_design.button_font_size : "18px"  rescue "18px"
