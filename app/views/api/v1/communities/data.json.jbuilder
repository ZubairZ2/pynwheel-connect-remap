  ...
  if gables_theme(@community) || @community.is_panther? || @community.is_expressionist?
    ...
    json.expressionist do
      json.global_navigation do
        ...
        json.display_apartment_btn_on_image @community.design.expressionist.display_apartment_btn_on_image.present? ? (Rails.env.development? ? local_assets_base_url+@community.design.expressionist.display_apartment_btn_on_image.url : @community.design.expressionist.display_apartment_btn_on_image.url) : "No Image"
        ...
        json.display_gallery_btn_on_image @community.design.expressionist.display_gallery_btn_on_image.present? ? (Rails.env.development? ? local_assets_base_url+@community.design.expressionist.display_gallery_btn_on_image.url : @community.design.expressionist.display_gallery_btn_on_image.url) : "No Image"
        ...
        json.display_neighborhood_btn_on_image @community.design.expressionist.display_neighborhood_btn_on_image.present? ? (Rails.env.development? ? local_assets_base_url+@community.design.expressionist.display_neighborhood_btn_on_image.url : @community.design.expressionist.display_neighborhood_btn_on_image.url) : "No Image"
        ...
        json.display_imagepage_btn_on_image @community.design.expressionist.display_imagepage_btn_on_image.present? ? (Rails.env.development? ? local_assets_base_url+@community.design.expressionist.display_imagepage_btn_on_image.url : @community.design.expressionist.display_imagepage_btn_on_image.url) : "No Image"
        ...
        json.display_webpage_btn_on_image @community.design.expressionist.display_webpage_btn_on_image.present? ? (Rails.env.development? ? local_assets_base_url+@community.design.expressionist.display_webpage_btn_on_image.url : @community.design.expressionist.display_webpage_btn_on_image.url) : "No Image"
        ...
        json.display_favourite_btn_on_image @community.design.expressionist.display_favourite_btn_on_image.present? ? (Rails.env.development? ? local_assets_base_url+@community.design.expressionist.display_favourite_btn_on_image.url : @community.design.expressionist.display_favourite_btn_on_image.url) : "No Image"
        ...
        json.display_apartment_btn_off_image @community.design.expressionist.display_apartment_btn_off_image.present? ? (Rails.env.development? ? local_assets_base_url+@community.design.expressionist.display_apartment_btn_off_image.url : @community.design.expressionist.display_apartment_btn_off_image.url) : "No Image"
        ...
        json.display_gallery_btn_off_image @community.design.expressionist.display_gallery_btn_off_image.present? ? (Rails.env.development? ? local_assets_base_url+@community.design.expressionist.display_gallery_btn_off_image.url : @community.design.expressionist.display_gallery_btn_off_image.url) : "No Image"
        ...
        json.display_neighborhood_btn_off_image @community.design.expressionist.display_neighborhood_btn_off_image.present? ? (Rails.env.development? ? local_assets_base_url+@community.design.expressionist.display_neighborhood_btn_off_image.url : @community.design.expressionist.display_neighborhood_btn_off_image.url) : "No Image"
        ...
        json.display_imagepage_btn_off_image @community.design.expressionist.display_imagepage_btn_off_image.present? ? (Rails.env.development? ? local_assets_base_url+@community.design.expressionist.display_imagepage_btn_off_image.url : @community.design.expressionist.display_imagepage_btn_off_image.url) : "No Image"
        ...
        json.display_webpage_btn_off_image @community.design.expressionist.display_webpage_btn_off_image.present? ? (Rails.env.development? ? local_assets_base_url+@community.design.expressionist.display_webpage_btn_off_image.url : @community.design.expressionist.display_webpage_btn_off_image.url) : "No Image"
        ...
        json.display_favourite_btn_off_image @community.design.expressionist.display_favourite_btn_off_image.present? ? (Rails.env.development? ? local_assets_base_url+@community.design.expressionist.display_favourite_btn_off_image.url : @community.design.expressionist.display_favourite_btn_off_image.url) : "No Image"
