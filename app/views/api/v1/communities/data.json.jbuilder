  ...
  if gables_theme(@community) || @community.is_panther? || @community.is_expressionist?
    ...
    json.expressionist do
      json.global_navigation do
        ...
        json.neighborhood_btn_on_image @community.design.expressionist.neighborhood_btn_on_image.present? ? (Rails.env.development? ? local_assets_base_url+@community.design.expressionist.neighborhood_btn_on_image : @community.design.expressionist.neighborhood_btn_on_image.url) : "No Image"
