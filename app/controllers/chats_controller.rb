class ChatsController < ApplicationController
    ...
    def create
        ...
        if chat.save
            ...
            render json: {responce: message, chatroom_id: chat.chatroom_id, meta: { stats: :OK, code: 200}}
        else
            render json: {responce: chat.full_messages.join(',') , meta: { stats: :Bad, code: 400}}
        end
    ...
    def listening_message
        ...
        if chats.present?
            ...
            render json: {responce: message_history,chatroom_id: params[:chatroom_id],  meta: {stats: :OK, code: 200} }
        else
            render json: {responce: [],chatroom_id: params[:chatroom_id], meta: {stats: :OK, code: 200} }
