...
#{app_link}"
  ...
  def tour_user_login
    ...
    if tu.blank?
      tu = TourUser.create(email: params[:email].downcase, name: params[:first_name] + " " + params[:last_name], first_name: params[:first_name], last_name: params[:last_name], phone_number: phone_number, id_selfie_mismatch: false, is_sms_enabled: params[:is_sms_enabled])
    else
      tu.update_attributes(name: params[:first_name] + " " + params[:last_name], first_name: params[:first_name], last_name: params[:last_name], phone_number: phone_number, id_selfie_mismatch: false, is_sms_enabled: params[:is_sms_enabled])
    end
