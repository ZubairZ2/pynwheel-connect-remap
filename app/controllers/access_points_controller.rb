class AccessPointsController < ApplicationController
    ...
    def plot_access_point
        ...
        access_point.update_columns(community_id: @community.id, floor: params[:floor], x_plot: params[:x_plot], y_plot: params[:y_plot])
    ...
    def update_access_point_lock
        @access_point = @property_type.access_points.find params[:id]
        @access_point.update_columns(lock_provider: params[:lock_provider], access_code: params[:access_code])
    ...
    def add_new_access_points
        ...
        params[:floors].each do |floor|
            ...
            new_point.update_columns(community_id: @community.id, floor: floor.to_i, x_plot: access_point.x_plot, y_plot: access_point.y_plot)
        end
