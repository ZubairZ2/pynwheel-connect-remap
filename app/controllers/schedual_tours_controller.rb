    ...
    def send_email_and_other_notifications(schedual_tour,previous_tour,is_rescheduled,property_tour_type)
      ...
      previous_text = ""
        ...
        if community.community_tour.tour_setting.enable_header_footer
          ...
          email_content = (property_tour_type == "scheduled_tour" && is_rescheduled) ? "<div style='vertical-align:middle; text-align:center'><p style='text-align: center; font-size: 16px; margin-bottom: 10px; line-height: 22px;'>Thank you <b>#{tu.name}</b> for rescheduling your tour! We look forward to having you at the <b>#{community.name if community.present?}</b> on <b>#{schedual_tour.tour_date.strftime("%A, %b %-d, %Y")}</b> at <b>#{ Time.parse(schedual_tour.tour_time.to_s).strftime("%-I:%M %P")}</b> #{previous_text} When you go to the property, you will need <br/></p> </div> <ul><li style='font-size: 18px;'>A photo ID</li> <li style='font-size: 18px;'>Your mobile device with the Pynwheel Self Tour app installed.</li></ul> <div style='vertical-align:middle; text-align:center'><p style='text-align: center; font-size: 16px; margin-bottom: 10px; line-height: 22px;'><b>Please download Self Tour app before you arrive:</b></div>" : 
          if property_tour_type == "unscheduled_self_tour"
            ...
            "<div style='vertical-align:middle; text-align:center'><p style='text-align: center; font-size: 16px; margin-bottom: 10px; line-height: 22px;'> Thank you <b>#{tu.name}</b> for scheduling your tour! We look forward to having you at the <b>#{community.name if community.present?}</b> on  <b>#{schedual_tour.tour_date.strftime("%A, %b %-d, %Y")}</b> at <b>#{ Time.parse(schedual_tour.tour_time.to_s).strftime("%-I:%M %P")}</b>. When you go to the property, you will need <br/></p></div> <ul><li style='font-size: 18px;'>A photo ID</li><li style='font-size: 18px;'>Your mobile device with the Pynwheel Self Tour app installed.</li></ul><div style='vertical-align:middle; text-align:center'><p style='text-align: center; font-size: 16px; margin-bottom: 10px; line-height: 22px;'><b>Please download Self Tour app before you arrive:</b></div> #{community.email_text.gsub("\n", "<br>").html_safe rescue ""}"
          end
        else
          if previous_tour[:tour_date].present? && previous_tour[:tour_time].present?
            previous_text = "instead of <b>#{previous_tour[:tour_date].strftime("%A, %b %-d, %Y")}</b> at <b>#{ Time.parse(previous_tour[:tour_time].to_s).strftime("%-I:%M %P")}</b>."
          end
          email_content = (property_tour_type == "scheduled_tour" && is_rescheduled) ? "<div style='vertical-align:middle; text-align:center'><img style='height: 100px;' src='#{community.logo.present? ? community.logo.url : ''}' data-title='#{community.name}' /><p style='text-align: center; font-size: 16px; margin-bottom: 10px; line-height: 22px;'><br/><p class='mt-10' style='text-align: center; font-size: 16px; margin-bottom: 10px; line-height: 22px;'>Thank you for rescheduling your tour! We look forward to having you at the <b>#{community.name if community.present?}</b> on <b>#{schedual_tour.tour_date.strftime("%A, %b %-d, %Y")}</b> at <b>#{ Time.parse(schedual_tour.tour_time.to_s).strftime("%-I:%M %P")}</b> #{previous_text} When you go to the property, you will need</p></div> <ul><li style='font-size: 18px;'>A photo ID</li> <li style='font-size: 18px;'>Your mobile device with the Pynwheel Self Tour app installed.</li></ul><div style='font-size: 18px;text-align:center'>Please download Self Tour app before you arrive: <br>iPhone Users: <a href=#{app_link} target='_blank'>Download Pynwheel Self Tour from the App Store</a><br>Android Users: <a href=#{android_link} target='_blank'>Download Pynwheel Self Tour from Google Play</a><br></div>" : 
          if property_tour_type == "unscheduled_self_tour"
            "<div style='vertical-align:middle; text-align:center;'><img style='max-height: 100px;' src='#{community.logo.present? ? community.logo.url : '/assets/logo-small.png'}' data-title='#{community.name}' /><br/><p class='mt-10' style='text-align: center; font-size: 16px; margin-bottom: 10px; line-height: 22px;'> We look forward to having you at <b>#{community.name if community.present?}!</b> Our visiting hours are:<br/>#{slot_str}<br/>When you go to the property, you will need a <b>photo ID</b> and a <b>mobile device</b> with the Pynwheel Self Tour app.</p></div><div style='text-align: center; font-size: 16px; margin-bottom: 10px; line-height: 22px;'><b>Please download the Pynwheel Self Tour app before you arrive:</b></p></div>"
          elsif property_tour_type == "remote_tour"
            "<div style='vertical-align:middle; text-align:center'><img style='max-height: 100px;' src='#{community.logo.present? ? community.logo.url : '/assets/logo-small.png'}' data-title='#{community.name}' /><br/><p class='mt-10' style='text-align: center; font-size: 16px; margin-bottom: 10px; line-height: 22px;'> Thank you <b>#{tu.name}</b> for choosing to tour <b>#{community.name if community.present?}</b> remotely! You can visit at any time from the comfort of your own home using our mobile app.</p><p style='text-align: center; font-size: 16px; margin-bottom: 10px; line-height: 22px; '><b>Please download the Pynwheel Self Tour app before you arrive:</b></p></div>"
          else
            "<div style='vertical-align:middle; text-align:center'><img style='height: 100px;' src='#{community.logo.present? ? community.logo.url : ''}' data-title='#{community.name}' /><br/><p style='text-align: center; font-size: 16px; margin-bottom: 10px; line-height: 22px;'>Thank you <b>#{tu.name}</b> for scheduling your tour! We look forward to having you at the <b>#{community.name if community.present?}</b> on <b>#{schedual_tour.tour_date.strftime("%A, %b %-d, %Y")}</b> at <b>#{ Time.parse(schedual_tour.tour_time.to_s).strftime("%-I:%M %P")}</b>. When you go to the property, you will </p></div> <br/> <ul><li style='font-size: 18px;'>A photo ID</li> <li style='font-size: 18px;'>Your mobile device with the Pynwheel Self Tour app installed.</li></ul><div style='font-size: 18px;text-align:center'>Please download Self Tour app before you arrive: <br>iPhone Users: <a href=#{app_link} target='_blank'>Download Pynwheel Self Tour from the App Store</a><br>Android Users: <a href=#{android_link} target='_blank'>Download Pynwheel Self Tour from Google Play</a><br></div><br/>"
          end
        end
      ...
      web_notification = (property_tour_type == "scheduled_tour" && is_rescheduled) ? "<div style='vertical-align:middle; text-align:center;'><img style='max-height: 100px;' src='#{community.logo.present? ? community.logo.url : '/assets/logo-small.png'}' data-title='#{community.name}' /><br/><p class='mt-10' style='text-align: center; font-size: 16px; margin-bottom: 10px; line-height: 22px; font-family: Poppins;'>Thank you, <b>#{tu.name}</b> Your reservation is rescheduled. We look forward to having you at <b>#{community.name if community.present?}</b> on <b>#{schedual_tour.tour_date.strftime("%A, %b %-d, %Y")}</b> at <b>#{ Time.parse(schedual_tour.tour_time.to_s).strftime("%-I:%M %P")}</b> #{previous_text} Please keep an eye out for texts and emails with further instructions.</p><p style='text-align: center; font-size: 16px; margin-bottom: 10px; line-height: 22px; font-family: Poppins;'><b>Please download the Pynwheel Self Tour app before you arrive:</b></p></div>" : 
      if property_tour_type == "unscheduled_self_tour"
        "<div style='vertical-align:middle; text-align:center;'><img style='max-height: 100px;' src='#{community.logo.present? ? community.logo.url : '/assets/logo-small.png'}' data-title='#{community.name}' /><br/><p class='mt-10' style='text-align: center; font-size: 16px; margin-bottom: 10px; line-height: 22px; font-family: Poppins;'> Thank you, <b>#{tu.name}</b> We look forward to having you at <b>#{community.name if community.present?}!</b> Our visiting hours are:</p><p style='text-align: center; font-size: 16px; margin-bottom: 10px; line-height: 22px;font-family: Poppins !important; padding-right: 8%;padding-left: 5%'>#{slot_str}</p><p style='text-align: center; font-size: 16px; margin-bottom: 10px; line-height: 22px;font-family: Poppins !important;'>When you go to the property, you will need a <b>photo ID</b> and a <b>mobile device</b> with the Pynwheel Self Tour app.</p></div><div style='text-align: center; font-size: 16px; margin-bottom: 10px; line-height: 22px;font-family: Poppins !important;'><b>Please download the Pynwheel Self Tour app before you arrive:</b></p></div>"
      elsif property_tour_type == "remote_tour"
        "<div style='vertical-align:middle; text-align:center'><img style='max-height: 100px;' src='#{community.logo.present? ? community.logo.url : '/assets/logo-small.png'}' data-title='#{community.name}' /><br/><p class='mt-10' style='text-align: center; font-size: 16px; margin-bottom: 10px; line-height: 22px; font-family: Poppins;'> Thank you, <b>#{tu.name}</b> for choosing to tour <b>#{community.name if community.present?}</b> remotely! You can visit at any time from the comfort of your own home using our mobile app.</p><p style='text-align: center; font-size: 16px; margin-bottom: 10px; line-height: 22px; font-family: Poppins;'><b>Please download the Pynwheel Self Tour app before you arrive:</b></p></div>"
      else
        "<div style='vertical-align:middle; text-align:center'><img style='max-height: 100px;' src='#{community.logo.present? ? community.logo.url : '/assets/logo-small.png'}' data-title='#{community.name}' /><br/><p class='mt-10' style='text-align: center; font-size: 16px; margin-bottom: 10px; line-height: 22px; font-family: Poppins;'> Thank you, <b>#{tu.name}</b> Your reservation is confirmed. We look forward to having you at <b>#{community.name if community.present?}</b> on <b>#{schedual_tour.tour_date.strftime("%A, %b %-d, %Y")}</b> <br/>at <b>#{ Time.parse(schedual_tour.tour_time.to_s).strftime("%-I:%M %P")}</b>. Please keep an eye out for texts and emails with further instructions. </p><p style='text-align: center; font-size: 16px; margin-bottom: 10px; line-height: 22px; font-family: Poppins;'><b>Please download the Pynwheel Self Tour app before you arrive:</b></p></div>"
      end 
