class SchedualToursController < ApplicationController
  ...
  def update
    ...
    @schedual_tour.update_attributes(knock_prospect_discover_source: params[:knock_prospect_discover_source]) if @schedual_tour.community.is_funnel_community? && params[:knock_prospect_discover_source].present?
