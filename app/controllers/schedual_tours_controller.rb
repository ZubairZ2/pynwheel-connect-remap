...
Get information about your tour here: #{confirmation_page_link}"
      ...
      community_mail = is_rescheduled && property_tour_type == "scheduled_tour" && (schedual_tour.tour_type == "self_tour" ||  schedual_tour.tour_type == "guided_tour" ) ? "<div style='vertical-align:middle; text-align:center'><img style='width: 150px;' src='#{community.logo_for_email}' data-title='#{community.name.humanize}' /></div><br/>
