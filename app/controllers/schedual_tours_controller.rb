      ...
      previous_text = ""
        ...
        if community.community_tour.tour_setting.enable_header_footer
          ...
          if property_tour_type == "unscheduled_self_tour"
            ...
            "<div style='vertical-align:middle; text-align:center'><p style='text-align: center; font-size: 16px; margin-bottom: 10px; line-height: 22px;'> Thank you <b>#{tu.name}</b> for scheduling your tour! We look forward to having you at the <b>#{community.name if community.present?}</b> on  <b>#{schedual_tour.tour_date.strftime("%A, %b %-d, %Y")}</b> at <b>#{ Time.parse(schedual_tour.tour_time.to_s).strftime("%-I:%M %P")}</b>. When you go to the property, you will need <br/></p></div> <ul><li style='font-size: 16px; text-align: left; line-height: 22px; margin-bottom: 10px;'>A photo ID</li><li style='font-size: 16px; text-align: left; line-height: 22px; margin-bottom: 10px;'>Your mobile device with the Pynwheel Self Tour app installed.</li></ul><div style='vertical-align:middle; text-align:center'><p style='text-align: center; font-size: 16px; margin-bottom: 10px; line-height: 22px;'><b>Please download Self Tour app before you arrive:</b></div> #{community.email_text.gsub("\n", "<br>").html_safe rescue ""}"
          end
        else
          if previous_tour[:tour_date].present? && previous_tour[:tour_time].present?
            previous_text = "instead of <b>#{previous_tour[:tour_date].strftime("%A, %b %-d, %Y")}</b> at <b>#{ Time.parse(previous_tour[:tour_time].to_s).strftime("%-I:%M %P")}</b>."
          ...
          if property_tour_type == "unscheduled_self_tour"
            ...
            "<div style='vertical-align:middle; text-align:center'><img style='height: 100px;' src='#{community.logo.present? ? community.logo.url : ''}' data-title='#{community.name}' /><br/><p style='text-align: center; font-size: 16px; margin-bottom: 10px; line-height: 22px;'>Thank you <b>#{tu.name}</b> for scheduling your tour! We look forward to having you at the <b>#{community.name if community.present?}</b> on <b>#{schedual_tour.tour_date.strftime("%A, %b %-d, %Y")}</b> at <b>#{ Time.parse(schedual_tour.tour_time.to_s).strftime("%-I:%M %P")}</b>. When you go to the property, you will </p></div> <br/> <ul><li style='font-size: 16px; text-align: left; line-height: 22px; margin-bottom: 10px;'>A photo ID</li> <li style='font-size: 16px; text-align: left; line-height: 22px; margin-bottom: 10px;'>Your mobile device with the Pynwheel Self Tour app installed.</li></ul><div style='font-size: 18px;text-align:center'>Please download Self Tour app before you arrive: <br>iPhone Users: <a href=#{app_link} target='_blank'>Download Pynwheel Self Tour from the App Store</a><br>Android Users: <a href=#{android_link} target='_blank'>Download Pynwheel Self Tour from Google Play</a><br></div><br/>"
          end
        end
