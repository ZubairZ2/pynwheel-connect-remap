    ...
    def send_email_and_other_notifications(schedual_tour,previous_tour,is_rescheduled,property_tour_type)
      ...
      previous_text = ""
        ...
        if community.community_tour.tour_setting.enable_header_footer
          ...
          email_content = (property_tour_type == "scheduled_tour" && is_rescheduled) ? "<p style='vertical-align:middle; text-align:center'><span style='font-weight: normal; font-size: 18px;'>Thank you <b>#{tu.name}</b> for rescheduling your tour! We look forward to having you at the <b>#{community.name if community.present?}</b> on <b>#{schedual_tour.tour_date.strftime("%A, %b %-d, %Y")}</b> at <b>#{ Time.parse(schedual_tour.tour_time.to_s).strftime("%-I:%M %P")}</b> #{previous_text} When you go to the property, you will need <br/></span> </p> <ul><li style='font-size: 18px;'>A photo ID</li> <li style='font-size: 18px;'>Your mobile device with the Pynwheel Self Tour app installed.</li></ul> <p style='vertical-align:middle; text-align:center'><span style='font-weight: normal; font-size: 18px;'><b>Please download Self Tour app before you arrive:</b></p>" : 
          if property_tour_type == "unscheduled_self_tour"
            "<p style='vertical-align:middle; text-align:center;'><span class='mt-10' style='font-weight: normal; font-size: 18px;'> Thank you, <b>#{tu.name}</b> We look forward to having you at <b>#{community.name if community.present?}!</b> Our visiting hours are:</span>
            <span style='text-align:center;font-size: 18px;padding-right: 8%;padding-left: 5%'>#{slot_str}</span><span style='text-align:center;font-size: 18px;'>When you go to the property, you will need a <b>photo ID</b> and a <b>mobile device</b> with the Pynwheel Self Tour app.</span><p style='text-align:center;font-size: 18px;'><b>Please download the Pynwheel Self Tour app before you arrive:</b></span></p>"
          elsif property_tour_type == "remote_tour"
            "<p style='vertical-align:middle; text-align:center'><span class='mt-10' style='font-weight: normal; font-size: 18px; '> Thank you <b>#{tu.name}</b> for choosing to tour <b>#{community.name if community.present?}</b> remotely! You can visit at any time from the comfort of your own home using our mobile app.</span><span style='font-weight: normal; font-size: 18px;'><b>Please download the Pynwheel Self Tour app before you arrive:</b></span></p>"
          else 
            "<p style='vertical-align:middle; text-align:center'><span style='font-weight: normal; font-size: 18px;'> Thank you <b>#{tu.name}</b> for scheduling your tour! We look forward to having you at the <b>#{community.name if community.present?}</b> on  <b>#{schedual_tour.tour_date.strftime("%A, %b %-d, %Y")}</b> at <b>#{ Time.parse(schedual_tour.tour_time.to_s).strftime("%-I:%M %P")}</b>. When you go to the property, you will need <br/></span></p> <ul><li style='font-size: 18px;'>A photo ID</li><li style='font-size: 18px;'>Your mobile device with the Pynwheel Self Tour app installed.</li></ul><p style='vertical-align:middle; text-align:center'><span style='font-weight: normal; font-size: 18px;'><b>Please download Self Tour app before you arrive:</b></p> #{community.email_text.gsub("\n", "<br>").html_safe rescue ""}"
          end
        else
          if previous_tour[:tour_date].present? && previous_tour[:tour_time].present?
            previous_text = "instead of <b>#{previous_tour[:tour_date].strftime("%A, %b %-d, %Y")}</b> at <b>#{ Time.parse(previous_tour[:tour_time].to_s).strftime("%-I:%M %P")}</b>."
          end
          email_content = (property_tour_type == "scheduled_tour" && is_rescheduled) ? "<p style='vertical-align:middle; text-align:center'><img style='height: 100px;' src='#{community.logo.present? ? community.logo.url : ''}' data-title='#{community.name}' /><span style='font-weight: normal; font-size: 18px;'><br/><span class='mt-10' style='font-weight: normal; font-size: 18px;'>Thank you for rescheduling your tour! We look forward to having you at the <b>#{community.name if community.present?}</b> on <b>#{schedual_tour.tour_date.strftime("%A, %b %-d, %Y")}</b> at <b>#{ Time.parse(schedual_tour.tour_time.to_s).strftime("%-I:%M %P")}</b> #{previous_text} When you go to the property, you will need</span></p> <ul><li style='font-size: 18px;'>A photo ID</li> <li style='font-size: 18px;'>Your mobile device with the Pynwheel Self Tour app installed.</li></ul><p style='font-size: 18px;text-align:center'>Please download Self Tour app before you arrive: <br>iPhone Users: <a href=#{app_link} target='_blank'>Download Pynwheel Self Tour from the App Store</a><br>Android Users: <a href=#{android_link} target='_blank'>Download Pynwheel Self Tour from Google Play</a><br></p>" : 
          if property_tour_type == "unscheduled_self_tour"
            "<p style='vertical-align:middle; text-align:center;'><img style='max-height: 100px;' src='#{community.logo.present? ? community.logo.url : '/assets/logo-small.png'}' data-title='#{community.name}' /><br/><span class='mt-10' style='font-weight: normal; font-size: 18px;'> We look forward to having you at <b>#{community.name if community.present?}!</b> Our visiting hours are:<br/>#{slot_str}<br/>When you go to the property, you will need a <b>photo ID</b> and a <b>mobile device</b> with the Pynwheel Self Tour app.</span></p><p style='text-align:center;font-size: 18px;'><b>Please download the Pynwheel Self Tour app before you arrive:</b></span></p>"
          elsif property_tour_type == "remote_tour"
            "<p style='vertical-align:middle; text-align:center'><img style='max-height: 100px;' src='#{community.logo.present? ? community.logo.url : '/assets/logo-small.png'}' data-title='#{community.name}' /><br/><span class='mt-10' style='font-weight: normal; font-size: 18px;'> Thank you <b>#{tu.name}</b> for choosing to tour <b>#{community.name if community.present?}</b> remotely! You can visit at any time from the comfort of your own home using our mobile app.</span><span style='font-weight: normal; font-size: 18px; '><b>Please download the Pynwheel Self Tour app before you arrive:</b></span></p>"
          else
            "<p style='vertical-align:middle; text-align:center'><img style='height: 100px;' src='#{community.logo.present? ? community.logo.url : ''}' data-title='#{community.name}' /><br/><span style='font-weight: normal; font-size: 18px;'>Thank you <b>#{tu.name}</b> for scheduling your tour! We look forward to having you at the <b>#{community.name if community.present?}</b> on <b>#{schedual_tour.tour_date.strftime("%A, %b %-d, %Y")}</b> at <b>#{ Time.parse(schedual_tour.tour_time.to_s).strftime("%-I:%M %P")}</b>. When you go to the property, you will </span></p> <br/> <ul><li style='font-size: 18px;'>A photo ID</li> <li style='font-size: 18px;'>Your mobile device with the Pynwheel Self Tour app installed.</li></ul><p style='font-size: 18px;text-align:center'>Please download Self Tour app before you arrive: <br>iPhone Users: <a href=#{app_link} target='_blank'>Download Pynwheel Self Tour from the App Store</a><br>Android Users: <a href=#{android_link} target='_blank'>Download Pynwheel Self Tour from Google Play</a><br></p><br/>"
          end
        end
      ...
      web_notification = (property_tour_type == "scheduled_tour" && is_rescheduled) ? "<p style='vertical-align:middle; text-align:center;'><img style='max-height: 100px;' src='#{community.logo.present? ? community.logo.url : '/assets/logo-small.png'}' data-title='#{community.name}' /><br/><span class='mt-10' style='font-weight: normal; font-size: 18px;'>Thank you, <b>#{tu.name}</b> Your reservation is rescheduled. We look forward to having you at <b>#{community.name if community.present?}</b> on <b>#{schedual_tour.tour_date.strftime("%A, %b %-d, %Y")}</b> at <b>#{ Time.parse(schedual_tour.tour_time.to_s).strftime("%-I:%M %P")}</b> #{previous_text} Please keep an eye out for texts and emails with further instructions.</span><span style='font-weight: normal; font-size: 18px;'><b>Please download the Pynwheel Self Tour app before you arrive:</b></span></p>" : 
      if property_tour_type == "unscheduled_self_tour"
        "<p style='vertical-align:middle; text-align:center;'><img style='max-height: 100px;' src='#{community.logo.present? ? community.logo.url : '/assets/logo-small.png'}' data-title='#{community.name}' /><br/><span class='mt-10' style='font-weight: normal; font-size: 18px;'> Thank you, <b>#{tu.name}</b> We look forward to having you at <b>#{community.name if community.present?}!</b> Our visiting hours are:</span><span style='text-align:center;font-size: 18px; padding-right: 8%;padding-left: 5%'>#{slot_str}</span><span style='text-align:center;font-size: 18px;'>When you go to the property, you will need a <b>photo ID</b> and a <b>mobile device</b> with the Pynwheel Self Tour app.</span></p><p style='text-align:center;font-size: 18px;'><b>Please download the Pynwheel Self Tour app before you arrive:</b></span></p>"
      elsif property_tour_type == "remote_tour"
        "<p style='vertical-align:middle; text-align:center'><img style='max-height: 100px;' src='#{community.logo.present? ? community.logo.url : '/assets/logo-small.png'}' data-title='#{community.name}' /><br/><span class='mt-10' style='font-weight: normal; font-size: 18px;'> Thank you, <b>#{tu.name}</b> for choosing to tour <b>#{community.name if community.present?}</b> remotely! You can visit at any time from the comfort of your own home using our mobile app.</span><span style='font-weight: normal; font-size: 18px;'><b>Please download the Pynwheel Self Tour app before you arrive:</b></span></p>"
      else
        "<p style='vertical-align:middle; text-align:center'><img style='max-height: 100px;' src='#{community.logo.present? ? community.logo.url : '/assets/logo-small.png'}' data-title='#{community.name}' /><br/><span class='mt-10' style='font-weight: normal; font-size: 18px;'> Thank you, <b>#{tu.name}</b> Your reservation is confirmed. We look forward to having you at <b>#{community.name if community.present?}</b> on <b>#{schedual_tour.tour_date.strftime("%A, %b %-d, %Y")}</b> <br/>at <b>#{ Time.parse(schedual_tour.tour_time.to_s).strftime("%-I:%M %P")}</b>. Please keep an eye out for texts and emails with further instructions. </span><span style='font-weight: normal; font-size: 18px;'><b>Please download the Pynwheel Self Tour app before you arrive:</b></span></p>"
      end 
...
Get information about your tour here: #{confirmation_page_link}"
      ...
      community_mail = is_rescheduled && property_tour_type == "scheduled_tour" && (schedual_tour.tour_type == "self_tour" ||  schedual_tour.tour_type == "guided_tour" ) ? "<p style='vertical-align:middle; text-align:center'><img style='width: 150px;' src='#{community.logo.url}' data-title='#{community.name.humanize}' /></p><br/>
