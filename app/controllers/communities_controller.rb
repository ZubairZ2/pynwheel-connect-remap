class CommunitiesController < ApplicationController
  ...
  def community_params
    params.require(:community).permit(:name,:address,:number_of_units,:city,:state,:zip,:phone,:email,:description,:latitude,:longitude,:company_id,:logo,:secondary_logo,
      :data_provider,:theme_name,:code,:is_sitemap,:menu_button_shade,:locked,:website,:equal_housing_opportunity_logo,:handicap_accessible_logo,:powered_by_btn,:tour_setup_visible, :self_tour, :touchscreen_app, :chat_control ,:show_gesture_icons,:billing_type,:billing_rate,:date_installed,:billing_month,:is_vertical_app,
