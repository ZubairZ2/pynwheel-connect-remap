class CommunitiesController < ApplicationController
  ...
  def credentials
    ...
    @crm_credential = @community.crm_credential.present? ? @community.crm_credential : @community.build_crm_credential
  end
