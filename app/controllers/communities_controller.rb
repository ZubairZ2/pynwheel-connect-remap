  ...
  def community_params
    params.require(:community).permit(:name,:address,:city,:state,:zip,:phone,:email,:description,:latitude,:longitude,:company_id,:logo,:secondary_logo,
      ...
      :credential_attributes=>[:id,:url,:username,:password,:property_id,:pmc_id,:server_name,:database,:platform,:interface_entity,:site_id,:c_code,
        ...
        :filter_panel_background_image,:filter_button_as_image,:gallery_button_as_image,:filter_panel_background_as_image,:home_page_button_shape,
        ...
        :main_screen_attributes=>[:id,:appartments_button,:galleries_button,:neighborhood_button,:favorities_button,:menu_position,:manage_background,
          ...
          :home_page_button_border_color,:display_home_page_button_icon,:home_page_button_font_family,:home_page_button_font_size,
          :display_home_page_nav_background,:home_page_button_image,:display_global_navigation_button_border_color,:global_navigation_button_font_family,
      ...
      :filter_panel_button_text_font_size]])
  end
