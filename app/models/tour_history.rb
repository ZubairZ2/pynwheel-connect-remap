...
class TourHistory < ApplicationRecord
  ...
  def send_update_notifications
	...
	if self.left and !self.is_left
		...
		@thank_you_content  = @community.thank_you_message.present? ? @community.thank_you_message : "Thank you for visiting #{@community.name.titleize}! We hope you enjoyed your tour. Go back to the Pynwheel Self Tour app any time to review the details of your tour."
  ...
  def send_email_sms_or_both_to_touruser thank_you_msg
	if community.alert_contact == "email"
		send_email_tour_user "Thank you for visiting #{community.name.titleize}", thank_you_msg.gsub("\n", "<br>").html_safe
	elsif community.alert_contact == "phone"
